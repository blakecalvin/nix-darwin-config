...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Blake"
    user-mail-address "blakecalvin@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/blakecalvin/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/blakecalvin/bin" "/profile/bin" "/Users/blakecalvin/.npm-packages/bin" "/Users/blakecalvin/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
